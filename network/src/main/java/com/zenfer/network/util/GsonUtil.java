package com.zenfer.network.util;
...
public class GsonUtil {
    ...
    public static <T> T toObject(Object json, Class<T> clz) {
        ...
        return toObject(GsonUtil.toJsonString(json), clz, false);
    }
     ...
     * @return 对应实体类对象的数组
     */
    public static <T> List<T> toList(Object json, Class clz) {
        return toList(toJsonString(json), clz, false);
    }
