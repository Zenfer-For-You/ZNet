 ...
 */
public class NetworkResultConvertObserver extends BaseNetWorkDisposable<NetWordResult> {

    private BaseCallBack callBack;

    public NetworkResultConvertObserver(@Nullable BaseCallBack callBack) {
